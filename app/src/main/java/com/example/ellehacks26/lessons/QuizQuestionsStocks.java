 ...
 */
public class QuizQuestionsStocks extends Fragment {

    private static final String ARG_LAYOUT_ID = "layoutId";

    private int layoutId;

    public QuizQuestionsStocks() {
        // Required empty constructor
    }

    /** Factory method to create a fragment with a specific quiz layout */
    public static QuizQuestionsStocks newInstance(int layoutId) {
        QuizQuestionsStocks fragment = new QuizQuestionsStocks();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.layout_stocks_quiz, container, false);
